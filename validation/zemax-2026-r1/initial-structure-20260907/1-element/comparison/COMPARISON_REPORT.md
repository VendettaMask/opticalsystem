...
| [First Order](comparisons/first-order-c1/comparison.json) | Captured | Captured | Pass | 0 | Compare EFL and F-number via native MFE operands; TotalTrack is not equated to optical total length. |
...
| [Spot Diagram](comparisons/spot-diagram-c1/comparison.json) | Captured | Captured | Pass | 5.89364E-14 | Compare native RMS/GEO spot metrics only; point ordering and ray correspondence are not equated. |
...
| [MTF](comparisons/mtf-c1/comparison.json) | Captured | Captured | Pass | 0.00854412 |  |
...
| [Wavefront](comparisons/wavefront-c1/comparison.json) | Captured | Captured | Pass | 1.14171E-11 |  |
...
```json
{
  "inputPath": "D:\\Projects\\opticalsystem\\artifacts\\validation\\initial-structure-p5-20260907\\external\\1-element\\candidate.ZMX",
  "fileName": "candidate.ZMX",
  "fileLength": 5364,
  "sourceSha256": "0b1d6c32716c83fa4a879da2dce6116627a2eafb41b945c8912da1cfa5f32db4",
  "inputLastWriteUtc": "2026-09-07T13:05:24.2272219Z",
  "startedUtc": "2026-09-07T13:06:54.4704542+00:00",
  ...
  "zmxHeaderRecords": [
    "VERS 260127 47 20120530 20120530",
    "MODE SEQ",
  ...
  "zmxFileVersion": "VERS 260127 47 20120530 20120530",
  ...
  "zemaxParsing": {
    ...
    "surfaces": [
      ...
      },
      {
        ...
        "Radius": -51.1993456090226,
        "Thickness": 48.6920542441324,
        "Material": "",
        "Coating": "",
        "SemiDiameter": 3.90625,
        "ChipZone": 0,
  ...
  "completedUtc": "2026-09-07T13:07:35.2800555+00:00",
...
- MTF: Pass, NRMSE 0.00854412
- Wavefront: Pass, NRMSE 1.14171E-11
- Spot Diagram: Pass, NRMSE 5.89364E-14
- First Order: Pass, NRMSE 0
...
Settings origin: CapturedSettings; request SHA-256: `d6da17e8b0fcc0e5a63835443dd5dc97da18b0de477af7c9324b74d1a2cfea35`
...
[
  {
    ...
    "conclusion": "Pass",
    "extra": {
      "workbench": 50.08421391814721,
      "zemax": 50.08421391814721
    }
  },
  {
    "id": "FNumber",
    ...
    "conclusion": "Pass",
    "extra": {
      "workbench": 8.013474226903554,
      "zemax": 8.013474226903554
    }
  }
]
```
...
Settings origin: CapturedSettings; request SHA-256: `6df1b8afaa2d53571e2c83718d698143365d988ba2fbd2052a22f8b225edaa65`
...
[
  {
    ...
    "unit": "Micrometer",
    "count": 1,
    "maxAbsolute": 5.151434834260726E-13,
    "meanAbsolute": 5.151434834260726E-13,
    "rmse": 5.151434834260726E-13,
    "nrmse": 2.188381045549277E-14,
    "maxRelative": 2.188381045549277E-14,
    "p50": 5.151434834260726E-13,
    "p90": 5.151434834260726E-13,
    "p95": 5.151434834260726E-13,
    "pearson": null,
    "worstX": 0,
    "worstY": null,
    "coverage": 1,
    "conclusion": "Pass",
    "extra": {
      "workbench": 23.539935354209963,
      "zemax": 23.539935354209447
    }
  },
  {
    "id": "GeoSpotRadius",
    "unit": "Micrometer",
    "count": 1,
    "maxAbsolute": 1.5916157281026244E-12,
    "meanAbsolute": 1.5916157281026244E-12,
    "rmse": 1.5916157281026244E-12,
    "nrmse": 5.893639933743177E-14,
    "maxRelative": 5.893639933743177E-14,
    "p50": 1.5916157281026244E-12,
    "p90": 1.5916157281026244E-12,
    "p95": 1.5916157281026244E-12,
    "pearson": null,
    "worstX": 0,
    "worstY": null,
    "coverage": 1,
    "conclusion": "Pass",
    "extra": {
      "workbench": 27.005649242162796,
      "zemax": 27.005649242161205
    }
  }
]
```
...
Settings origin: CapturedSettings; request SHA-256: `9bd50172c39e9448ae69ddd6a9141efcccef7fbea1625617b9912cfaf2dcc69b`
...
[
  {
    ...
    "unit": "Dimensionless",
    "count": 336,
    "maxAbsolute": 0.018229239099035593,
    "meanAbsolute": 0.0071410644364442565,
    "rmse": 0.008544124739882928,
    "nrmse": 0.008544124739882928,
    "maxRelative": 1.5066312008679428,
    "p50": 0.00670061291910401,
    "p90": 0.01433790561966062,
    "p95": 0.01624616171361622,
    "pearson": 0.9996129101835334,
    "worstX": 15.050167224080267,
    "worstY": null,
    "coverage": 1,
    "conclusion": "Pass",
    "extra": {
      "workbench.dc": 1,
      "workbench.frequency10": 0.5186108695956249,
      "workbench.frequency20": 0.07479703704334016,
      "workbench.frequency30": 0.14174674092633255,
      "workbench.frequency50": 0.07563221236545331,
      "workbench.firstCrossing50": 10.2606021845212,
      "workbench.firstCrossing10": 16.22450468431133,
      "zemax.dc": 1,
      "zemax.frequency10": 0.5085117203502877,
      "zemax.frequency20": 0.08365174984080911,
      "zemax.frequency30": 0.13615027772796937,
      "zemax.frequency50": 0.07395307313571516,
      "zemax.firstCrossing50": 10.116040887331263,
      "zemax.firstCrossing10": 15.96921890850864
    }
  },
  {
    "id": "sagittal",
    "unit": "Dimensionless",
    "count": 336,
    "maxAbsolute": 0.01822923909903565,
    "meanAbsolute": 0.007141064436444251,
    "rmse": 0.008544124739882931,
    "nrmse": 0.008544124739882931,
    "maxRelative": 1.5066312008679446,
    "p50": 0.006700612919103899,
    "p90": 0.014337905619660626,
    "p95": 0.01624616171361629,
    "pearson": 0.9996129101835336,
    "worstX": 15.050167224080267,
    "worstY": null,
    "coverage": 1,
    "conclusion": "Pass",
    "extra": {
      "workbench.dc": 1,
      "workbench.frequency10": 0.5186108695956247,
      "workbench.frequency20": 0.07479703704334016,
      "workbench.frequency30": 0.1417467409263326,
      "workbench.frequency50": 0.07563221236545331,
      "workbench.firstCrossing50": 10.2606021845212,
      "workbench.firstCrossing10": 16.22450468431133,
      "zemax.dc": 1,
...
Settings origin: CapturedSettings; request SHA-256: `9a0c34761e9d92b93acd34d6a2a803465b3828cfc5d7f3eb5c6b048959bbc5a4`
...
- Undo Workbench display-only minimum offset: add -1.9329383951149932 waves, derived solely from native MeanOpticalPathDifference / wavelength minus displayed mean; retain signed chief-reference OPD, no fit to Zemax.
...
[
  {
    ...
    "unit": "Wave",
    "count": 3001,
    "maxAbsolute": 6.675260344479739E-11,
    "meanAbsolute": 1.771181798395748E-11,
    "rmse": 2.206845884541475E-11,
    "nrmse": 1.1417052349338847E-11,
    "maxRelative": "Infinity",
    "p50": 1.4179435403605112E-11,
    "p90": 3.604971876569607E-11,
    "p95": 4.516609308780062E-11,
    "pearson": 0.9999999999999979,
    "worstX": -0.16129032258064516,
    "worstY": -0.7741935483870968,
    "coverage": 1,
    "conclusion": "Pass",
    "extra": {
      "grid.workbench.peak": 8.881784197001252E-15,
      "grid.workbench.pv": 1.932938395115002,
      "grid.workbench.rmsAboutZero": 1.1875789873907951,
      "grid.workbench.rmsAfterPiston": 0.5569504658369776,
      "grid.zemax.peak": 0,
      "grid.zemax.pv": 1.9329383951447605,
      "grid.zemax.rmsAboutZero": 1.1875789873997742,
      "grid.zemax.rmsAfterPiston": 0.5569504658366266
    }
  }
]
```
