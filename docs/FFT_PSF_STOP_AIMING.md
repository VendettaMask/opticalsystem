...
2026-09-07 已根据实际 `zmax_38668.ZMX` 将 Working F/# 的表面口径忽略规则统一到公共计算，同时保留真实光瞳截光和整体瞄准切换，见 [38668 公共计算修复](ZEMAX_38668_WORKING_F_NUMBER.md)。下述“不忽略物理遮挡”适用于真实光瞳采样；尺度探针现按官方定义独立处理。
