...
- Kept still-unsupported geometries explicit: Forbes, Zernike, NURBS, grid-sag, and grating geometries still fail rather than being silently flattened.
