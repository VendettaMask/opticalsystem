...
| Analysis | Configurable analyses with graphical plots | One analysis page with metric table and text report | All 56 analyses are grouped in the top Analysis Ribbon; selecting one runs it into a closable page with bottom Plot/Data/Text tabs, collapsed graph settings, persisted parameters, and interactive plots |
