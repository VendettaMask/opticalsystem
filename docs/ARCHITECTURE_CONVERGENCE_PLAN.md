...
| 当前验证记录 | 持续维护 | 正式产品截至 2026-08-26 严格构建为 `0` 警告、`0` 错误，全量测试 `786/786`，其中全部非序列测试 `38/38`、新增杂散光专项 `11/11`。独立实验室构建为 `0` 警告、`0` 错误，定向测试 `7/7`，不并入正式基线 |
...
- 历史验证记录：截至2026-08-24的全量测试为 `739/739`，2026-08-25为 `775/775`；这些记录已由2026-08-26的 `786/786` 全量基线取代。
