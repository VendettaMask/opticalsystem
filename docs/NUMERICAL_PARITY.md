...
The validated repository baseline on 2026-07-29 is a zero-warning solution build with `569/569` passing tests. It includes the Huygens image-surface normal and Image Delta corrections, selectable Zemax-style image simulation, distortion and RMS reference-series regressions, compact spot-diagram layout, and merit-operand row-color coverage.
