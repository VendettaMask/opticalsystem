...
截至 2026-08-04，仓库当前记录和最近一次全量基线均为 `684/684`。STEP CAD 导出专项为 `17/17`，覆盖真实 Sag 与坐标变换、弦高误差、分面装配、胶合组分件、物理孔径、非法几何、三角形上限、取消/异常原子写入和 FreeCAD 样例生成；Linux CI 继续承担 OpenCascade 实际导入验收。
