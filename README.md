...
In restricted sandboxes, VSTest may need permission to bind a local socket. The current validated baseline is 183 passing tests with a zero-warning solution build.
