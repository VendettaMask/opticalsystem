...
def main():
    ...
    optic = CookeTriplet()
    cases = [
        {"name": "axis-chief-d", "field_x": 0, "field_y": 0, "pupil_x": 0, "pupil_y": 0, "wavelength_micrometers": 0.55},
        {"name": "axis-upper-d", "field_x": 0, "field_y": 0, "pupil_x": 0, "pupil_y": 1, "wavelength_micrometers": 0.55},
        {"name": "axis-lower-d", "field_x": 0, "field_y": 0, "pupil_x": 0, "pupil_y": -1, "wavelength_micrometers": 0.55},
        {"name": "mid-chief-d", "field_x": 0, "field_y": 0.7, "pupil_x": 0, "pupil_y": 0, "wavelength_micrometers": 0.55},
        {"name": "full-chief-d", "field_x": 0, "field_y": 1, "pupil_x": 0, "pupil_y": 0, "wavelength_micrometers": 0.55},
        {"name": "full-upper-d", "field_x": 0, "field_y": 1, "pupil_x": 0, "pupil_y": 1, "wavelength_micrometers": 0.55},
        {"name": "mid-oblique-f", "field_x": 0, "field_y": 0.7, "pupil_x": 0.5, "pupil_y": 0.5, "wavelength_micrometers": 0.48},
        {"name": "mid-oblique-c", "field_x": 0, "field_y": 0.7, "pupil_x": 0.5, "pupil_y": 0.5, "wavelength_micrometers": 0.65},
    ]
    output = {
        "source": "Optiland 0.5.8 optiland.samples.CookeTriplet",
        "prescription": {
        ...
        "line_y_bundles": [
            bundle_case(optic, 0, 0.55),
            bundle_case(optic, 0.7, 0.55),
            bundle_case(optic, 1, 0.55),
        ],
    }
