...
internal static class IsekaiTheme
{
    ...
    public static ThemePalette Palette { get; } = new(
        ...
        WarningSurface: Color.FromRgb(67, 50, 24),
        ErrorSurface: Color.FromRgb(65, 34, 28),
        SuccessSurface: Color.FromRgb(37, 55, 29),
        ...
        AnalysisRealRayRowBackground: Color.FromRgb(43, 49, 49),
        AnalysisRealRayRowForeground: Color.FromRgb(156, 207, 255),
        AnalysisParaxialRayRowBackground: Color.FromRgb(67, 50, 24),
        AnalysisParaxialRayRowForeground: Color.FromRgb(242, 183, 63),
