...
public sealed partial class MainWindow : Window
{
    ...
    private static readonly IReadOnlyList<AnalysisRibbonCommand> AnalysisRibbonCommands = new AnalysisRibbonCommand[]
    {
        ...
        new("analysis-rms-field", "RMS vs. 视场", "均方根随视场", "chart-line", "均方根"),
        new("analysis-rms-wavelength", "RMS vs. 波长", "均方根随波长", "chart-line", "均方根"),
        new("analysis-rms-focus", "RMS vs. 离焦", "均方根随离焦", "chart-line", "均方根"),
        new("analysis-rms-field-map", "二维视场RMS图", "二维视场均方根图", "map", "均方根"),
        new("analysis-angle-height", "入射角 vs. 像高", "入射角随像高", "scan-line", "光线迹点"),
        new("analysis-psf", "FFT PSF", "傅里叶点扩散函数", "focus", "点扩散函数"),
        new("analysis-psf-cross-section", "FFT PSF Cross Section", "傅里叶点扩散函数截面", "chart-line", "点扩散函数"),
        new("analysis-line-edge-spread", "FFT Line Edge Spread", "傅里叶线/边缘扩散", "chart-spline", "点扩散函数"),
        new("analysis-huygens-psf", "Huygens PSF", "惠更斯点扩散函数", "circle-dot-dashed", "点扩散函数"),
        new("analysis-huygens-psf-cross-section", "Huygens PSF Cross Section", "惠更斯点扩散函数截面", "chart-line", "点扩散函数"),
        new("analysis-mtf", "MTF", "傅里叶调制传递函数", "chart-no-axes-combined", "调制传递函数"),
        new("analysis-fourier-through-focus-mtf", "Fourier Through Focus MTF", "傅里叶离焦调制传递函数", "scan-line", "调制传递函数"),
        new("analysis-fourier-mtf-field", "Fourier MTF vs Field", "傅里叶调制传递函数随视场", "chart-line", "调制传递函数"),
        new("analysis-huygens-mtf", "惠更斯 MTF", "惠更斯调制传递函数", "waves-horizontal", "调制传递函数"),
        new("analysis-huygens-through-focus-mtf", "Huygens Through Focus MTF", "惠更斯离焦调制传递函数", "scan-line", "调制传递函数"),
        new("analysis-huygens-mtf-field", "Huygens MTF vs Field", "惠更斯调制传递函数随视场", "chart-line", "调制传递函数"),
        new("analysis-geometric-mtf", "几何 MTF", "几何调制传递函数", "chart-spline", "调制传递函数"),
        new("analysis-geometric-through-focus-mtf", "Geometric Through Focus MTF", "几何离焦调制传递函数", "scan-line", "调制传递函数"),
        new("analysis-geometric-mtf-field", "Geometric MTF vs Field", "几何调制传递函数随视场", "chart-line", "调制传递函数"),
        new("analysis-wavefront", "光程差图", "光程差图", "waves-horizontal", "波前"),
        ...
        new("analysis-zernike", "Zernike 系数", "泽尼克系数", "sigma", "波前"),
        new("analysis-zernike-fringe", "Zernike Fringe系数", "泽尼克条纹系数", "sigma", "波前"),
        new("analysis-zernike-standard", "Zernike Standard系数", "泽尼克标准系数", "sigma", "波前"),
        new("analysis-zernike-annular", "Zernike Annular系数", "泽尼克环形系数", "sigma", "波前"),
        new("analysis-zernike-field", "Zernike系数 vs. 视场", "泽尼克系数随视场", "chart-line", "波前"),
        new("analysis-jones-pupil", "Jones 瞳", "琼斯光瞳", "scan", "波前"),
        ...
        new("analysis-y-ybar", "Y-Ybar", "Y-Ȳ 图", "chart-no-axes-column", "光线迹点"),
    };
    ...
    private static readonly IReadOnlyList<AnalysisRibbonMenu> AnalysisRibbonMenus = new AnalysisRibbonMenu[]
    {
        ...
        new("调制传递函数", "调制传递函数", "chart-no-axes-combined", new[]
        {
            "analysis-mtf",
